...
GAIA_RA, GAIA_Dec = np.loadtxt('/Users/amandaquirk/Documents/M33/Data/gaia_dr1.csv', unpack = True)
...
GAIA_in_region1 = (GAIA_RA > RA_min1) & (GAIA_RA < RA_max1) & (GAIA_Dec > Dec_min1) & (GAIA_Dec < Dec_max1) 
GAIA_in_region2 = (GAIA_RA > RA_min2) & (GAIA_RA < RA_max2) & (GAIA_Dec > Dec_min2) & (GAIA_Dec < Dec_max2)
GAIA_in_region3 = (GAIA_RA > RA_min3) & (GAIA_RA < RA_max3) & (GAIA_Dec > Dec_min3) & (GAIA_Dec < Dec_max3)
GAIA_in_region4 = (GAIA_RA > RA_min4) & (GAIA_RA < RA_max4) & (GAIA_Dec > Dec_min4) & (GAIA_Dec < Dec_max4)

GAIA_RA_region1 = GAIA_RA[GAIA_in_region1]
GAIA_Dec_region1 = GAIA_Dec[GAIA_in_region1]
GAIA_RA_region2 = GAIA_RA[GAIA_in_region2]
GAIA_Dec_region2 = GAIA_Dec[GAIA_in_region2]
GAIA_RA_region3 = GAIA_RA[GAIA_in_region3]
GAIA_Dec_region3 = GAIA_Dec[GAIA_in_region3]
GAIA_RA_region4 = GAIA_RA[GAIA_in_region4]
GAIA_Dec_region4 = GAIA_Dec[GAIA_in_region4]

'''
===========================================================================================================================
save data to a file so that isolation can be run by julia
'''
# output_file = h5py.File('/Users/amandaquirk/Documents/M33/Data/isolated_HST_region1.hdf5', 'w')
# output_file.create_dataset("RAs", data=HST_RA_region1)
# output_file.create_dataset("Decs", data=HST_Dec_region1)
# output_file.create_dataset("mag", data=F814W_region1)
# output_file.close() 

# output_file = h5py.File('/Users/amandaquirk/Documents/M33/Data/isolated_HST_region2.hdf5', 'w')
# output_file.create_dataset("RAs", data=HST_RA_region2)
# output_file.create_dataset("Decs", data=HST_Dec_region2)
# output_file.create_dataset("mag", data=F814W_region2)
# output_file.close() 

# output_file = h5py.File('/Users/amandaquirk/Documents/M33/Data/isolated_HST_region3.hdf5', 'w')
# output_file.create_dataset("RAs", data=HST_RA_region3)
# output_file.create_dataset("Decs", data=HST_Dec_region3)
# output_file.create_dataset("mag", data=F814W_region3)
# output_file.close() 

# output_file = h5py.File('/Users/amandaquirk/Documents/M33/Data/isolated_HST_region4.hdf5', 'w')
# output_file.create_dataset("RAs", data=HST_RA_region4)
# output_file.create_dataset("Decs", data=HST_Dec_region4)
# output_file.create_dataset("mag", data=F814W_region4)
# output_file.close() 

# output_file = h5py.File('/Users/amandaquirk/Desktop/GAIA_region1.hdf5', 'w')
# output_file.create_dataset("RAs", data=GAIA_RA_region1)
# output_file.create_dataset("Decs", data=GAIA_Dec_region1)
# output_file.close() 

# output_file = h5py.File('/Users/amandaquirk/Desktop/GAIA_region2.hdf5', 'w')
# output_file.create_dataset("RAs", data=GAIA_RA_region2)
# output_file.create_dataset("Decs", data=GAIA_Dec_region2)
# output_file.close() 

# output_file = h5py.File('/Users/amandaquirk/Desktop/GAIA_region3.hdf5', 'w')
# output_file.create_dataset("RAs", data=GAIA_RA_region3)
# output_file.create_dataset("Decs", data=GAIA_Dec_region3)
# output_file.close() 

# output_file = h5py.File('/Users/amandaquirk/Desktop/GAIA_region4.hdf5', 'w')
# output_file.create_dataset("RAs", data=GAIA_RA_region4)
# output_file.create_dataset("Decs", data=GAIA_Dec_region4)
# output_file.close() 
...
'''
============================================================================================================================
isolation done in julia
-read in the isolation tag for each region
-1 means not isolated!
'''

# tag1 = np.loadtxt('/Users/amandaquirk/Documents/M33/Data/isolation_tag_HST_region1.txt')
# tag2 = np.loadtxt('/Users/amandaquirk/Documents/M33/Data/isolation_tag_HST_region2.txt')
# tag3 = np.loadtxt('/Users/amandaquirk/Documents/M33/Data/isolation_tag_HST_region3.txt')
# tag4 = np.loadtxt('/Users/amandaquirk/Documents/M33/Data/isolation_tag_HST_region4.txt')
...
# HST_RA_region1_keep = HST_RA_region1[isolated_1]
# HST_Dec_region1_keep = HST_Dec_region1[isolated_1]
# F814W_region1_keep = F814W_region1[isolated_1]
# F475W_region1_keep = F475W_region1[isolated_1]

# HST_RA_region2_keep = HST_RA_region2[isolated_2]
# HST_Dec_region2_keep = HST_Dec_region2[isolated_2]
# F814W_region2_keep = F814W_region2[isolated_2]
# F475W_region2_keep = F475W_region2[isolated_2]

# HST_RA_region3_keep = HST_RA_region3[isolated_3]
# HST_Dec_region3_keep = HST_Dec_region3[isolated_3]
# F814W_region3_keep = F814W_region3[isolated_3]
# F475W_region3_keep = F475W_region3[isolated_3]

# HST_RA_region4_keep = HST_RA_region4[isolated_4]
# HST_Dec_region4_keep = HST_Dec_region4[isolated_4]
# F814W_region4_keep = F814W_region4[isolated_4]
# F475W_region4_keep = F475W_region4[isolated_4]
...
GAIA_coords1 = SkyCoord(GAIA_RA_region1, GAIA_Dec_region1, unit=(u.deg, u.deg))
GAIA_coords2 = SkyCoord(GAIA_RA_region2, GAIA_Dec_region2, unit=(u.deg, u.deg))
GAIA_coords3 = SkyCoord(GAIA_RA_region3, GAIA_Dec_region3, unit=(u.deg, u.deg))
GAIA_coords4 = SkyCoord(GAIA_RA_region4, GAIA_Dec_region4, unit=(u.deg, u.deg))
...
idx_1, d2d_1, d3d_1 = CFHT_coords1.match_to_catalog_sky(GAIA_coords1)
idx_2, d2d_2, d3d_2 = CFHT_coords2.match_to_catalog_sky(GAIA_coords2)
idx_3, d2d_3, d3d_3 = CFHT_coords3.match_to_catalog_sky(GAIA_coords3)
idx_4, d2d_4, d3d_4 = CFHT_coords4.match_to_catalog_sky(GAIA_coords4)
...
GAIA_RA_region1 = GAIA_RA_region1[idx_1]
GAIA_Dec_region1 = GAIA_Dec_region1[idx_1]

GAIA_RA_region2 = GAIA_RA_region2[idx_2]
GAIA_Dec_region2 = GAIA_Dec_region2[idx_2]

GAIA_RA_region3 = GAIA_RA_region3[idx_3]
GAIA_Dec_region3 = GAIA_Dec_region3[idx_3]

GAIA_RA_region4 = GAIA_RA_region4[idx_4]
GAIA_Dec_region4 = GAIA_Dec_region4[idx_4]
...
good_match_1 = d2d_1.arcsecond < 1
GAIA_RA_region1 = GAIA_RA_region1[good_match_1]
GAIA_Dec_region1 = GAIA_Dec_region1[good_match_1]
CFHT_RA_region1 = CFHT_RA_region1[good_match_1]
CFHT_Dec_region1 = CFHT_Dec_region1[good_match_1]
CFHT_i_region1 = CFHT_i_region1[good_match_1]

good_match_2 = d2d_2.arcsecond < 1
GAIA_RA_region2 = GAIA_RA_region2[good_match_2]
GAIA_Dec_region2 = GAIA_Dec_region2[good_match_2]
CFHT_RA_region2 = CFHT_RA_region2[good_match_2]
CFHT_Dec_region2 = CFHT_Dec_region2[good_match_2]
CFHT_i_region2 = CFHT_i_region2[good_match_2]

good_match_3 = d2d_3.arcsecond < 1
GAIA_RA_region3 = GAIA_RA_region3[good_match_3]
GAIA_Dec_region3 = GAIA_Dec_region3[good_match_3]
CFHT_RA_region3 = CFHT_RA_region3[good_match_3]
CFHT_Dec_region3 = CFHT_Dec_region3[good_match_3]
CFHT_i_region3 = CFHT_i_region3[good_match_3]

good_match_4 = d2d_4.arcsecond < 1
GAIA_RA_region4 = GAIA_RA_region4[good_match_4]
GAIA_Dec_region4 = GAIA_Dec_region4[good_match_4]
CFHT_RA_region4 = CFHT_RA_region4[good_match_4]
CFHT_Dec_region4 = CFHT_Dec_region4[good_match_4]
CFHT_i_region4 = CFHT_i_region4[good_match_4]
...
np.savetxt('/Users/amandaquirk/Documents/M33/Data/GAIA_region1_matched.txt', np.c_[GAIA_RA_region1, GAIA_Dec_region1], fmt='%1.16f', delimiter=' ', header='RA (deg), Dec (deg)')
np.savetxt('/Users/amandaquirk/Documents/M33/Data/GAIA_region2_matched.txt', np.c_[GAIA_RA_region2, GAIA_Dec_region2], fmt='%1.16f', delimiter=' ', header='RA (deg), Dec (deg)')
np.savetxt('/Users/amandaquirk/Documents/M33/Data/GAIA_region3_matched.txt', np.c_[GAIA_RA_region3, GAIA_Dec_region3], fmt='%1.16f', delimiter=' ', header='RA (deg), Dec (deg)')
np.savetxt('/Users/amandaquirk/Documents/M33/Data/GAIA_region4_matched.txt', np.c_[GAIA_RA_region4, GAIA_Dec_region4], fmt='%1.16f', delimiter=' ', header='RA (deg), Dec (deg)')
...
def matching_plot(RA1, RA2, Dec1, Dec2, region_name):
	...
	plt.savefig('/Users/amandaquirk/Desktop/gaia_matching_coordinates_{}.png'.format(region_name), bbox='tight')
	plt.close()

# C1_RA, C1_Dec = np.loadtxt('/Users/amandaquirk/Documents/M33/Data/CFHT_region1.txt', usecols=(0,1,), unpack = True)
# H1_RA, H1_Dec = np.loadtxt('/Users/amandaquirk/Documents/M33/Data/HST_region1.txt', usecols=(0,1,), unpack = True)
# C2_RA, C2_Dec = np.loadtxt('/Users/amandaquirk/Documents/M33/Data/CFHT_region2.txt', usecols=(0,1,), unpack = True)
# H2_RA, H2_Dec = np.loadtxt('/Users/amandaquirk/Documents/M33/Data/HST_region2.txt', usecols=(0,1,), unpack = True)
# C3_RA, C3_Dec = np.loadtxt('/Users/amandaquirk/Documents/M33/Data/CFHT_region3.txt', usecols=(0,1,), unpack = True)
# H3_RA, H3_Dec = np.loadtxt('/Users/amandaquirk/Documents/M33/Data/HST_region3.txt', usecols=(0,1,), unpack = True)
# C4_RA, C4_Dec = np.loadtxt('/Users/amandaquirk/Documents/M33/Data/CFHT_region4.txt', usecols=(0,1,), unpack = True)
# H4_RA, H4_Dec = np.loadtxt('/Users/amandaquirk/Documents/M33/Data/HST_region4.txt', usecols=(0,1,), unpack = True)

# matching_plot(np.array(H1_RA), np.array(C1_RA), np.array(H1_Dec), np.array(C1_Dec), 'region1')
# matching_plot(np.array(H2_RA), np.array(C2_RA), np.array(H2_Dec), np.array(C2_Dec), 'region2')
# matching_plot(np.array(H3_RA), np.array(C3_RA), np.array(H3_Dec), np.array(C3_Dec), 'region3')
# matching_plot(np.array(H4_RA), np.array(C4_RA), np.array(H4_Dec), np.array(C4_Dec), 'region4')

matching_plot(GAIA_RA_region1, CFHT_RA_region1, GAIA_Dec_region1, CFHT_Dec_region1, 'region1')
matching_plot(GAIA_RA_region2, CFHT_RA_region2, GAIA_Dec_region2, CFHT_Dec_region2, 'region2')
matching_plot(GAIA_RA_region3, CFHT_RA_region3, GAIA_Dec_region3, CFHT_Dec_region3, 'region3')
matching_plot(GAIA_RA_region4, CFHT_RA_region4, GAIA_Dec_region4, CFHT_Dec_region4, 'region4')

# plt.scatter(C1_RA, C1_Dec, c='r', alpha = 0.8, label = 'CFHT')
# plt.scatter(H1_RA, H1_Dec, c='b', alpha = 0.3, label = 'HST')
# plt.scatter(C2_RA, C2_Dec, c='r', alpha = 0.8, label = 'CFHT')
# plt.scatter(H2_RA, H2_Dec, c='b', alpha = 0.3, label = 'HST')
# plt.scatter(C3_RA, C3_Dec, c='r', alpha = 0.8, label = 'CFHT')
# plt.scatter(H3_RA, H3_Dec, c='b', alpha = 0.3, label = 'HST')
# plt.scatter(C4_RA, C4_Dec, c='r', alpha = 0.8, label = 'CFHT')
# plt.scatter(H4_RA, H4_Dec, c='b', alpha = 0.3, label = 'HST')
# plt.xlabel('RA')
# plt.ylabel('Dec')
# plt.xlim(23.64,23.58)
# plt.ylim(30.74, 30.84)
# plt.legend()
# plt.savefig('/Users/amandaquirk/Desktop/examining_coordinate_matching_region4.png')
